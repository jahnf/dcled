...
function(add_version_info target directory)
  ...
  string(MAKE_C_IDENTIFIER "${target}" TARGET)
  ...
  set(output_dir "${CMAKE_CURRENT_BINARY_DIR}/version/${TARGET}")

  get_version_info(${TARGET} "${directory}")
  if(${${TARGET}_VERSION_SUCCESS})
    ...
    set(VERSION_DISTANCE ${${TARGET}_VERSION_DISTANCE})
    ...
    set(VERSION_ISDIRTY ${${TARGET}_VERSION_ISDIRTY})
  ...
  foreach(template_file ${ARGN})
    ...
    set(output_file "${output_dir}/${TARGET}-${output_basename}")
